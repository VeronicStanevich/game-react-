        ...
        <div>
            ...
            <div className="cards_design">
                <div onClick={setCardDesign(1)}
                     className={`card_design card_design_1 ${cardDesign === 1 ? 'active' : ''}`}></div>
                <div onClick={setCardDesign(2)}
                     className={`card_design card_design_2 ${cardDesign === 2 ? 'active' : ''}`}></div>
                <div onClick={setCardDesign(3)}
                     className={`card_design card_design_3 ${cardDesign === 3 ? 'active' : ''}`}></div>
            </div>
